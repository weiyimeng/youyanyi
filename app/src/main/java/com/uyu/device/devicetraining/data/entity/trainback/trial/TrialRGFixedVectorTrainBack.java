 ...
 */
public class TrialRGFixedVectorTrainBack extends RGFixedVectorTrainBack {
    ...
    public static TrialRGFixedVectorTrainBack convert(JSONObject jsonObject) throws JSONException {
        try {
            TrialRGFixedVectorTrainBack trainBack = new TrialRGFixedVectorTrainBack();
    ...
    public void computeScore(){
        score = (resultDifficulty * 100)/ RGFixedVectorConfig.Max_Level;
    }
}
