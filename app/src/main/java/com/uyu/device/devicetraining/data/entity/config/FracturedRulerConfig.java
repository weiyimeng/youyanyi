...
//    public static final int Fail_Max_Time = 1;
     ...
     * 需要训练的总关数
     */
    public static final int Need_Train_Total_Level_Count = 9;
     ...
     * 挡板的位置(单位：mm)
     */
    private static int[] arrayBaffleLocation = {
            260,
            246, 223,
            203, 186,
            171, 156,
     ...
     * @return
     */
    public static int getBaffleLocation(int level){
