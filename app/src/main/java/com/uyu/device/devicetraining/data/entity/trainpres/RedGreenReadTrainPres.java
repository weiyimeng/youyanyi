...
public class RedGreenReadTrainPres extends TrainPres {
    ...
    public static RedGreenReadTrainPres convert(JSONObject jsonObject) throws JSONException {
        try {
            RedGreenReadTrainPres trainPres = new RedGreenReadTrainPres();
     ...
     * @return
     */
    public static boolean isCompletedEqual(RedGreenReadTrainPres previousTrainPres, RedGreenReadTrainPres trainPres){
