...
public class ScoreManager {
     ...
     * 单眼标准60s的个数
     */
    public static int Single60SecondStandard = 22;
    /**
     * 双眼标准60s的个数
     */
    public static int Double60SecondStandard = 16;
    /**
     * 单位60
     */
    public static int Unit60Second = 60;

    /**
     * 计算翻转拍视疲劳得分
     * @param eyeType 眼睛类型
     * @param list 训练细节
     * @param trainTimeSecond 训练时长
     * @return
     */
    public static int computeReversalTrain(EnumEyeType eyeType, List<ReversalTrainBackDetail> list, int trainTimeSecond){
        ...
        if(countSum==0){
            ...
            int standardCount = getStandardCount(eyeType,trainTimeSecond);
    ...
    public static int getStandardCount(EnumEyeType eye_type, int trainTimeSecond){
        int eye60SecondStandard = Single60SecondStandard;
        if(eye_type== EnumEyeType.DOUBLE){
            eye60SecondStandard = Double60SecondStandard;
        }
        int standardCount = eye60SecondStandard * trainTimeSecond/Unit60Second;
