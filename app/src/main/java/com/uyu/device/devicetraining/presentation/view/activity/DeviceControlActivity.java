...
import com.uyu.device.devicetraining.domain.bluetooth.le.BluetoothLeService;
import com.uyu.device.devicetraining.domain.bluetooth.le.SampleGattAttributes;
...
public class DeviceControlActivity extends Activity {
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            mBluetoothLeService = ((BluetoothLeService.BluetoothLeServiceBinder) service).getService();
