...
@Table(database = AppDatabase.class,
        ...
        inheritedPrimaryKeys = {@InheritedPrimaryKey(column = @Column,
                ...
                fieldName = "localId")})
public class FracturedRulerTrainBack extends TrainBack {
    ...
    public void setEyeChanges(String eyeChanges) {
        this.eyeChanges = eyeChanges;
    }

    public FracturedRulerTrainBack(){
    ...
    public void convertParent(JSONObject jsonObject) throws JSONException {
        try {
            ...
            setEyeChanges(jsonObject.getString("eye_changes"));
        }catch (JSONException e){
            throw e;
        }
    }

    public static FracturedRulerTrainBack convert(JSONObject jsonObject) throws JSONException {
        try {
            FracturedRulerTrainBack trainBack = new FracturedRulerTrainBack();
    ...
    public JSONObject toJson() throws JSONException{
        try {
            ...
            jsonObject.put("eye_changes", eyeChanges);
