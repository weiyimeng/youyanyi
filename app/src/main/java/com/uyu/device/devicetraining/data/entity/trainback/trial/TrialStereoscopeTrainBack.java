 ...
 */
public class TrialStereoscopeTrainBack extends StereoscopeTrainBack {
    ...
    public static TrialStereoscopeTrainBack convert(JSONObject jsonObject) throws JSONException {
        try {
            TrialStereoscopeTrainBack trainBack = new TrialStereoscopeTrainBack();
    ...
    public void computeScore(){
        score = (resultDifficulty * 100)/ StereoscopeConfig.Max_Level;
    }
}
