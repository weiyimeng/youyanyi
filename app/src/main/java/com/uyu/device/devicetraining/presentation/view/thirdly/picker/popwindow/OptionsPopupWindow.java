...
import com.uyu.device.devicetraining.presentation.view.thirdly.picker.view.WheelOptions;
...
public class OptionsPopupWindow extends PopupWindow implements OnClickListener {
    ...
    public OptionsPopupWindow(Context context) {
        ...
        rootView = mLayoutInflater.inflate(R.layout.uikit_pw_options, null);
        // -----确定和取消按钮
        ...
        wheelOptions.screenheight = (int) (screenInfo.getHeight());
