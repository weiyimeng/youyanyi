 ...
 */
@PerActivity
public class RGVariableVectorTrainPresenter extends TrainPresenter<RGVariableVectorTrainPres,RGVariableVectorTrainBack,TrainNormal> implements OnFinishResultListener {
    /**
     * 构造函数
     */

    @Inject
    public RGVariableVectorTrainPresenter(@Named("trainBackUseCase") TrainBackUseCase trainBackUseCase
    ...
    protected void newTrainBack() {
        trainBack = new RGVariableVectorTrainBack();
